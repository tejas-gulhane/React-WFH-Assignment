...
import './Module.css'
import img1 from '../../../images/M1-T1.png'
import img2 from '../../../images/m1-t2.png'
import img3 from '../../../images/m1-t3.png'
  ...
  return (
    <>
        <div className='heading_module'>
            <div className='heading_module_left'>Module1</div>
        ...
        <div className='maincontent_module'>
            <div className='maincontent_module_tabs'>
                <button onClick={tab1clicked} className="active tab1">Tab 1</button>
                <button onClick={tab2clicked} className="tab2">Tab 2</button>
                <button onClick={tab3clicked} className="tab3">Tab 3</button>
            </div>
